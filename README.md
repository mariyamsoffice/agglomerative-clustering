...
I have implemented Agglomerative Clustering algorithm using Python.

Agglomerative clustering is a hierarchical clustering method used in unsupervised machine learning to group similar data points together. It starts by considering each data point as a separate cluster, and then gradually merges pairs of clusters into larger clusters until all the points belong to a single cluster.

In this program, I have used a dataset entailing some employees' annual income and their spending scores.
